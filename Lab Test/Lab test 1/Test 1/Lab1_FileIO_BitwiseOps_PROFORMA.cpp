...
File version: 2018_v01.1

*******************************************************************************************************
*******************************************************************************************************

IMPORTANT:  This is the Lab Test 1 Resit version - there are a few modifications in this file when
            compared to the original version. Specifically a GENERAL SPECIFICATIONS section has been 
			added which is common to all three EEET2250 Laboratory Tests.
...
You final program should take command line program that reads (a filename) parameter from the command
line, reads data from the designated file and prints out a well defined result, and nothing else. No
...
in your code). Valid data read from file is then written out to PORTB, maintaining the current state of
...
int main(int argc, char *argv[])
{
	if (argc == 1)  
	{
		...
		cout << "1224567,s1224567@student.rmit.edu.au,Tara-Louise_Brown" << endl ;
